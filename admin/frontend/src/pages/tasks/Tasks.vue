<template>
  ...
  <div class="mx-auto max-w-3xl">
    ...
    <!-- Site filter -->
    <div v-if="siteFilter" class="mt-4 flex items-center gap-2 rounded-lg bg-surface-blue-1 px-3 py-2">
    ...
    <div v-else-if="visibleTasks.length" class="bg-surface-elevation-1 mt-4 divide-outline-gray-1 divide-y overflow-hidden">
      <RouterLink v-for="task in visibleTasks" :key="task.task_id" :to="taskDetailRoute(task.task_id)"
