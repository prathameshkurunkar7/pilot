...
class BaseTask:
    #: The bench CLI/admin-API command name this task runs as (e.g. "migrate").
    #: Concrete tasks set this; pilot.tasks.registry discovers them by it.
    command: ClassVar[str] = ""
    #: Args submit()/run() callers must supply for this command.
